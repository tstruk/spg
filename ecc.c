 ...
 * $Id: ecc.c 272 2009-04-02 05:54:52Z tadeusz $
 *
 ...
 */
static struct timeval ecc_time_before_op;
static struct timeval ecc_time_after_op;
...
status ec_generate_key(EC_private_key_t* priv_key, const char *curve_name)
{
	...
	gettimeofday(&ecc_time_before_op, &tz);
	/*
	 * Make sure d < n
	 */ 
	...
	gettimeofday(&ecc_time_after_op, &tz);
